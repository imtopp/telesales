...
namespace App\Http\Controllers\Backend\Content\ManagePayment;
...
class LocationMappingController extends BaseController
{
  ...
  public function index(){
    ...
    return view('backend/content/payment/location_mapping',['payment_method'=>$payment_method]); //display list_product view with all_category and all_product
  }
