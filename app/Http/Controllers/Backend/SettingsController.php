...
class SettingsController extends BaseController
{
  ...
  public function applicationProperties(){
    return view('backend/settings/application_properties'); //display list_product view with all_category and all_product
  }

  public function updateApplicationProperties(Factory $cache){
  ...
  public function manageUserRead(){
    ...
    foreach($users as $user){
      ...
      $user_list[] = array('id'=>$user->id,'email'=>$user->email,'role'=>$role->name,'status'=>$user->status);
    }*/
  ...
  public function manageUserUpdate(){
    $date = DateTime::createFromFormat('Y-m-d H:i:s', date('Y-m-d H:i:s')); //initialize date parameter
  ...
  public function manageUserDestroy(){
    try {
