...
@section('page-js-script')
  ...
  var table;
    ...
    function initializeModal(element,title,id,name,province_id,status){
    ...
    function edit(e) {
      initializeModal($("#modal-template").html(),"Edit Data",$(e).data('id'),$(e).data('name'),$(e).data('province_id'),$(e).data('status'));
      showModal();
      $('#modal_view').on('hidden.bs.modal',function(){
        resetModal();
      });
