...
@section('title', 'Manage Location City')
...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Manage Location City Page</h2>
        <div class="clearfix"></div>
      </div>
      <div class="x_content">
        <h4>Welcome to Manage Location City Page</h4>
        <span>
          Selamat datang di halaman manage location city. halaman ini digunakan untuk mengatur lokasi kota pada aplikasi {{ config('settings.app_name') }}
...
@section('page-js-script')
      ...
      <div id="message">
        ...
        <div class="form-group">
          <div class="controls">
            ...
            {!! Form::select('province_id', $province, null, ["class"=>"form-control","required","id"=>"province_id"]); !!}
          </div>
        </div>
        <div class="form-group">
          <div class="controls">
  ...
  var table;
    $(document).ready(function() {
      ...
      table = $('#datatable').dataTable({
        ...
        ajax: {
          ...
          url: "{{URL::route('administrator_manage_location_city_read')}}",
          type: "POST",
    ...
    function initializeModal(mode,element,title,id,name,province_id,status){
      $.spin("show");
    ...
    function create(){
      ...
      setSubmitModalEvent('{{URL::route('administrator_manage_location_city_create')}}');
    }

    function edit(e){
      initializeModal("update",$("#modal-template").html(),"Edit Data",$(e).data('id'),$(e).data('name'),$(e).data('province_id'),$(e).data('status'));

      setSubmitModalEvent('{{URL::route('administrator_manage_location_city_update')}}');
    }

    function destroy(e){
      initializeModal("delete",$("#modal-template-delete").html(),"Delete Data",$(e).data('id'),$(e).data('name'));

      setSubmitModalEvent('{{URL::route('administrator_manage_location_city_destroy')}}');
    }
  </script>
@stop
