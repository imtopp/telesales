...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Manage Product Category Page</h2>
        <div class="clearfix"></div>
      </div>
      <div class="x_content">
        <h4>Welcome to Manage Product Category Page</h4>
        <span>
          Selamat datang di halaman manage product category. halaman ini digunakan untuk mengatur kategori product pada aplikasi {{ config('settings.app_name') }}
          anda dapat mengatur category pada tabel dibawah.
        </span>
...
@section('page-js-script')
  ...
  var table;
    $(document).ready(function() {
      table = $('#datatable').dataTable({
        ...
        ajax: {
          ...
          url: "{{URL::route('administrator_manage_product_category_read')}}",
          type: "POST",
    ...
    function create(){
      ...
      setSubmitModalEvent('{{URL::route('administrator_manage_product_category_create')}}');
    }
    ...
    function edit(e) {
      ...
      setSubmitModalEvent('{{URL::route('administrator_manage_product_category_update')}}');
    }
    ...
    function destroy(e) {
      ...
      setSubmitModalEvent('{{URL::route('administrator_manage_product_category_destroy')}}');
    }
  </script>
@stop
