...
@section('page-js-script')
  ...
  var table;
    $(document).ready(function() {
      ...
      table = $('#datatable').dataTable({
        ...
        ajax: {
          ...
          url: "{{URL::route('backend_manage_location_province_read')}}",
          type: "POST",
    ...
    function create(){
      ...
      setSubmitModalEvent('{{URL::route('backend_manage_location_province_create')}}');
    }
    ...
    function edit(e) {
      ...
      setSubmitModalEvent('{{URL::route('backend_manage_location_province_update')}}');
    }
    ...
    function destroy(e) {
      ...
      setSubmitModalEvent('{{URL::route('backend_manage_location_province_destroy')}}');
    }
  </script>
@stop
