  ...
  var table;
    $(document).ready(function() {
      table = $('#datatable').dataTable({
        ...
        ajax: {
          ...
          url: "{{URL::route('backend_manage_payment_method_location_mapping_read')}}",
          type: "POST",
    ...
    function initializeModal(element,title,id,province_id,city_id,district_id,payment_method_id,status){
      ...
      if($("#province_id").is("select")){
        $(function(){
          $.ajax({
            url : '{{URL::route('backend_manage_payment_method_location_mapping_get_province')}}',
            type: 'POST',
            dataType: 'JSON',
            data: {"_token":"{{ csrf_token() }}"},
        ...
        $("#province_id").change(function(){
          if($("#province_id").val()!=""){
            $.ajax({
              url : '{{URL::route('backend_manage_payment_method_location_mapping_get_city')}}',
              type: 'POST',
              dataType: 'JSON',
        ...
        $("#city_id").change(function(){
          if($("#city_id").val()!=""){
            $.ajax({
              url : '{{URL::route('backend_manage_payment_method_location_mapping_get_district')}}',
              type: 'POST',
              dataType: 'JSON',
    ...
    function create(){
      ...
      setSubmitModalEvent('{{URL::route('backend_manage_payment_method_location_mapping_create')}}');
    }
    ...
    function edit(e) {
      ...
      setSubmitModalEvent('{{URL::route('backend_manage_payment_method_location_mapping_update')}}');
    }
    ...
    function destroy(e) {
      ...
      setSubmitModalEvent('{{URL::route('backend_manage_payment_method_location_mapping_destroy')}}');
    }
  </script>
@stop
