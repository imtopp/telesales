...
@section('page-js-script')
  ...
  var table;
    $(document).ready(function() {
      ...
      table = $('#datatable').dataTable({
        ...
        ajax: {
          ...
          url: "{{URL::route('backend_manage_product_category_read')}}",
          type: "POST",
    ...
    function create(){
      ...
      setSubmitModalEvent('{{URL::route('backend_manage_product_category_create')}}');
    }
    ...
    function edit(e) {
      ...
      setSubmitModalEvent('{{URL::route('backend_manage_product_category_update')}}');
    }
    ...
    function destroy(e) {
      ...
      setSubmitModalEvent('{{URL::route('backend_manage_product_category_destroy')}}');
    }
  </script>
@stop
