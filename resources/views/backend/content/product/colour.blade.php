...
@section('page-js-script')
  ...
  var table;
    $(document).ready(function() {
      table = $('#datatable').dataTable({
        ...
        ajax: {
          ...
          url: "{{URL::route('backend_manage_product_colour_read')}}",
          type: "POST",
    ...
    function create(){
      ...
      setSubmitModalEvent('{{URL::route('backend_manage_product_colour_create')}}');
    }
    ...
    function edit(e) {
      ...
      setSubmitModalEvent('{{URL::route('backend_manage_product_colour_update')}}');
    }
    ...
    function destroy(e) {
      ...
      setSubmitModalEvent('{{URL::route('backend_manage_product_colour_destroy')}}');
    }
    ...
    function view(e){
      ...
      setSubmitModalEvent('{{URL::route('backend_manage_product_colour_upload')}}');
    }
  </script>
@stop
