...
@section('page-js-script')
  <script type = "text/template" id="modal-template">
    ...
    <div class="modal-body">
      <div id="message">
        ...
        <div class="form-group">
          <div class="controls">
            {!! Form::label("product_colour_id", "Produk") !!}
            {!! Form::select('product_colour_id', $product_colour, null, ["class"=>"form-control","required","id"=>"product_colour_id"]); !!}
          </div>
        </div>
        <div class="form-group">
          <div class="controls">
  ...
  var table;
    $(document).ready(function() {
      $("#manage-product-fg_code").addClass("current-page");
      $("#manage-product-fg_code").parent().show();
      $("#manage-product-fg_code").parent().parent().addClass("active");
      ...
      table = $('#datatable').dataTable({
        ...
        ajax: {
          ...
          url: "{{URL::route('backend_manage_product_fg_code_read')}}",
          type: "POST",
    ...
    function initializeModal(element,title,id,fg_code,product_id,price,status){
    ...
    function create(){
      ...
      setSubmitModalEvent('{{URL::route('backend_manage_product_fg_code_create')}}');
    }

    function edit(e) {
      initializeModal($("#modal-template").html(),"Edit Data",$(e).data('id'),$(e).data('fg_code'),$(e).data('product_id'),$(e).data('price'),$(e).data('status'));
      showModal();
      $('#modal_view').on('hidden.bs.modal',function(){
        resetModal();
      });

      setSubmitModalEvent('{{URL::route('backend_manage_product_fg_code_update')}}');
    }
    ...
    function destroy(e) {
      ...
      setSubmitModalEvent('{{URL::route('backend_manage_product_fg_code_destroy')}}');
    }
  </script>
@stop
