  ...
  var table;
    ...
    function initializeModal(element,title,id,fg_code,category_id,product_id,colour_id,price,status){
      ...
      if($("#category_id").is("select")){
        $(function(){
          $.ajax({
            url : '{{URL::route('backend_manage_product_fg_code_get_category')}}',
            type: 'POST',
            dataType: 'JSON',
            data: {"_token":"{{ csrf_token() }}"},
        ...
        $("#category_id").change(function(){
          if($("#category_id").val()!=""){
            $.ajax({
              url : '{{URL::route('backend_manage_product_fg_code_get_product')}}',
              type: 'POST',
              dataType: 'JSON',
        ...
        $("#product_id").change(function(){
          if($("#product_id").val()!=""){
            $.ajax({
              url : '{{URL::route('backend_manage_product_fg_code_get_colour')}}',
              type: 'POST',
              dataType: 'JSON',
