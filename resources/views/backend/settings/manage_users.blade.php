...
@section('sidebar-menu')
  @include('backend\layout\sidebar_menu_settings')
@endsection
...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <h4>This is page that you can manage {{ config('settings.app_name') }} Application users</h4>
...
@section('page-js-script')
  ...
  <script type = "text/template" id="modal-template-delete">
    ...
    <div class="modal-body">
      <div id="message">
        ...
        <h4>Apakah anda yakin menghapus <span id="email"></span> ?</h4>
      </div>
    </div>
    <div id="footer" class="modal-footer">
      <div class="form-group">
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      table = $('#datatable').dataTable({
        ...
        ajax: {
          ...
          url: "{{URL::route('backend_settings_manage_users_read')}}",
          type: "POST",
    ...
    function create(){
      ...
      setSubmitModalEvent('{{URL::route('backend_settings_manage_users_create')}}');
    }
    ...
    function edit(e) {
      ...
      setSubmitModalEvent('{{URL::route('backend_settings_manage_users_update')}}');
    }
    ...
    function destroy(e) {
      ...
      setSubmitModalEvent('{{URL::route('backend_settings_manage_users_destroy')}}');
    }
  </script>
@stop
