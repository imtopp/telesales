...
@endforeach
{!!Form::open(['url'=>URL::route('login'),'id'=>"login_form",'class'=>'form form-horizontal'])!!}
<h1>Login Form</h1>
...
<div>
    ...
    {!!HTML::link(URL::route('forget_password'),'Lost your password?',['class'=>'reset_pass link'])!!}
</div>
...
<div class="separator">
  <p class="change_link">New to site?
    {!!HTML::link(URL::route('register'),'Create Account',['class'=>'to_register link'])!!}
  </p>
